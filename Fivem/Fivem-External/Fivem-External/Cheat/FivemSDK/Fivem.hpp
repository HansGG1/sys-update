...
namespace Cheat
{
	enum GAME_VERSION
	{
		...
		// Newer builds (b3258 / b3323 / b3407 / b3570) and
		// FiveM 2.0's generic FiveM_GTAProcess.exe — found via AOB scanning.
		GAME_VERSION_GENERIC,
	};
	...
	public:
		...
		bool IsEntityVisible(const Entity& e);	// combines VisibilityBase + LOD flag
		...
		std::set<std::string> FriendNames;
		std::mutex            FriendNamesMtx;
