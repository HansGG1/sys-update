...
namespace Cheat
{
	...
	public:
		...
		bool IsVisible()
		{
			...
			BYTE flag = FrameWork::Memory::ReadMemory<BYTE>(this + VisibleFlag);
			// 0 = out of range, 4 = in range but occluded/culled, 36 = streaming transition
			if (flag == 0 || flag == 4 || flag == 36)
				return false;
